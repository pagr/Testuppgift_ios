...
class ImagesViewController: UIViewController {
    ...
    @IBAction func loadImagesButtonPressed(sender: AnyObject) {
        imageView1.loadImageFromUrl(NSURL(string: "http://img.dn.se/remoted1.dn-static.se/UploadedImages/2016/7/12/aa8e1a21-9f08-437d-9299-2177635298d2/bigOriginal.jpg?preset=AlmaSectionTeaserUncroppedDesktop")!)
